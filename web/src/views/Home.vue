  ...
  <div class="min-h-screen bg-background">
    ...
    <header class="fixed top-0 left-0 right-0 z-50 border-b bg-background/80 backdrop-blur-md">
      <nav class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div class="hidden md:flex items-center gap-8">
          <a href="#why-elynd" class="text-sm text-muted-foreground hover:text-foreground transition-colors">
            为什么做
          </a>
    ...
    <section class="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-28">
      <div class="absolute inset-0 -z-10">
        <div class="absolute left-1/2 top-0 -translate-x-1/2 w-[1000px] h-[600px] bg-primary/5 rounded-full blur-3xl" />
        <div class="absolute right-0 top-1/4 w-[400px] h-[400px] bg-secondary/10 rounded-full blur-3xl" />
      </div>
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
          ...
          <h1 class="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
            让英语阅读
            <span class="text-primary">变得更简单</span>
          </h1>
    ...
    <!-- Why Elynd Section -->
    <section id="why-elynd" class="py-20 lg:py-28 relative overflow-hidden">
      <div class="absolute inset-0 -z-10">
        <div class="absolute left-0 top-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-3xl" />
        <div class="absolute right-0 bottom-0 w-[400px] h-[400px] bg-secondary/5 rounded-full blur-3xl" />
      </div>
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card 
            v-for="(point, index) in PAIN_POINTS" 
            :key="point.title"
            :class="[
              'border-muted hover:border-primary/30 transition-all duration-300 hover:shadow-lg',
              index % 2 === 1 ? 'md:mt-0 lg:mt-12' : ''
            ]"
          >
            <CardHeader>
              <div class="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-lg bg-muted text-muted-foreground">
                <component :is="point.icon" class="size-5" />
              </div>
              <CardTitle class="text-lg">{{ point.title }}</CardTitle>
            </CardHeader>
            <CardContent>
    ...
    <section id="solution" class="py-20 lg:py-28 bg-muted/30">
      <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card 
            v-for="point in SOLUTION_POINTS" 
            :key="point.title"
            class="border-muted hover:border-primary/30 transition-all duration-300 hover:shadow-lg group"
          >
            <CardContent class="pt-6">
              <div class="flex items-start gap-4">
                <div class="flex shrink-0 h-14 w-14 items-center justify-center rounded-xl bg-primary/10 text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
                  <component :is="point.icon" class="size-7" />
                </div>
                <div>
                  <h3 class="text-xl font-semibold mb-1">{{ point.title }}</h3>
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card 
            ...
            :key="feature.title" 
            class="group border-muted hover:border-primary/30 transition-all duration-300"
            :style="{ animationDelay: `${index * 100}ms` }"
          >
            <CardHeader>
              <div class="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
    ...
    <section id="how-it-works" class="py-20 lg:py-28">
      <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative">
          <div class="hidden md:block absolute top-8 left-[20%] right-[20%] h-0.5 bg-border" />
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div v-for="step in STEPS" :key="step.number" class="relative flex flex-col items-center text-center">
              <div class="relative z-10 flex h-16 w-16 items-center justify-center rounded-full bg-primary text-primary-foreground text-2xl font-bold shadow-lg">
                {{ step.number }}
              </div>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4 py-8">
          <div class="flex items-center gap-2">
            <div class="flex h-6 w-6 items-center justify-center rounded-md bg-primary">
              <BookOpen class="size-4 text-primary-foreground" />
            </div>
            <span class="font-semibold">Elynd</span>
          </div>
