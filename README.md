...
| 模块 | 功能描述 | 用户价值 |
|-----|---------|---------|
| **用户系统** | 注册 / 登录 / 学习记录 | 个性化学习体验，数据追踪 |
| **文章内容** | 预置分级文章 (职场/日常/科技) | 精准匹配学习需求 |
| **阅读功能** | 完整文章展示 + 点击查词 | 沉浸式阅读，零障碍 |
| **听读功能** | TTS 音频播放/暂停/重播 | 多感官学习，听读结合 |
| **查词功能** | 点击单词显示中英文释义 | 即时获取词义，保持阅读流畅 |
| **AI 问答** | 基于当前文章智能问答 | 个性化辅导，深入理解 |
