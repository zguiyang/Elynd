...
const routes = {
  ...
  'auth.email_verify_get': {
    ...
    tokens: [{"old":"/api/auth/email/verify","type":0,"val":"api","end":""},{"old":"/api/auth/email/verify","type":0,"val":"auth","end":""},{"old":"/api/auth/email/verify","type":0,"val":"email","end":""},{"old":"/api/auth/email/verify","type":0,"val":"verify","end":""}],
  ...
  'auth.resend_verification': {
    ...
    tokens: [{"old":"/api/auth/email/resend","type":0,"val":"api","end":""},{"old":"/api/auth/email/resend","type":0,"val":"auth","end":""},{"old":"/api/auth/email/resend","type":0,"val":"email","end":""},{"old":"/api/auth/email/resend","type":0,"val":"resend","end":""}],
    types: placeholder as Registry['auth.resend_verification']['types'],
  },
  'auth.forgot_password': {
    methods: ["POST"],
    pattern: '/api/auth/password/forgot',
    tokens: [{"old":"/api/auth/password/forgot","type":0,"val":"api","end":""},{"old":"/api/auth/password/forgot","type":0,"val":"auth","end":""},{"old":"/api/auth/password/forgot","type":0,"val":"password","end":""},{"old":"/api/auth/password/forgot","type":0,"val":"forgot","end":""}],
    types: placeholder as Registry['auth.forgot_password']['types'],
  },
  'auth.reset_password': {
    methods: ["POST"],
    pattern: '/api/auth/password/reset',
    tokens: [{"old":"/api/auth/password/reset","type":0,"val":"api","end":""},{"old":"/api/auth/password/reset","type":0,"val":"auth","end":""},{"old":"/api/auth/password/reset","type":0,"val":"password","end":""},{"old":"/api/auth/password/reset","type":0,"val":"reset","end":""}],
