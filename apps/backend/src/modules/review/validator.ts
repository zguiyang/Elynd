...
export const validateReplaceReviewItems = validated('json', replaceReviewItemsBodySchema);
export const validateGenerateReviewItems = validated('json', generateReviewItemsBodySchema);
export const validateReviewAnswer = validated('json', reviewAnswerBodySchema);
